...
MODEL              = mainSim
MODULES            = mainSim_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = mainSim.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Users\atchase\DOCUME~1\Dropbox\Thesis\PLANES~1
S_FUNCTIONS        = saerofgpacknetfdm.c saeroclockpacer.c sf_sfun.c saerojoystick.c
S_FUNCTIONS_LIB    = 
SOLVER             = ode45.c
NUMST              = 3
TID01EQ            = 0
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f C:\Users\atchase\AppData\Roaming\MATHWO~1\MATLAB\R2011b\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\mainSim
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\aeroblks\aeroblks
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\aero\aero\src
