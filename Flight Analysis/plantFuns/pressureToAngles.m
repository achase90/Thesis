...
alpha = interp1(cAlphaCalib,alphaCalib,cAlpha)+7; %todo: go back to above lines when you have new alignment calibration
...
alphaNoise = 0.2*ones(size(alpha)); %based on stated manufacturer accuracy. Should be calculated
betaNoise = alphaNoise;